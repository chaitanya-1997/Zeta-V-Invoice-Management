...
//       // Run 3 queries in parallel: count, applied candidates, manually added candidates
//       let completed = 0;
...
//               candidates: appliedCandidates,           // website applicants
//               manual_candidates: manualCandidates,     // manually added
//             },
//           });
//         }
//       };
...
//         if (err) { console.error("Count error:", err); hasError = true; }
...
//       jobModel.addCandidateToJob(jobId, candidateId, addedBy, candidateStatus, (err, result) => {
//         if (err) {
